...
const CounterApp: React.FC = () => {
	...
	// return (
	// 	<div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-r from-orange-500 to-pink-500">
	// 		<h1 className="mb-6 font-extrabold text-6xl">🤖 Fun Counter App 🎉</h1>
	...
	// 				className="bg-green-500 rounded-full text-white text-lg font-semibold py-3 px-8 hover:bg-green-600 transition duration-300 shadow-lg transform hover:scale-105"
	// 			>
	// 				Increment 🚀
	// 			</button>
	// 			<button
	// 				onClick={() => setCount(count - 1)}
	// 				className="bg-red-500 rounded-full text-white text-lg font-semibold py-3 px-8 hover:bg-red-600 transition duration-300 shadow-lg transform hover:scale-105"
	// 			>
	// 				Decrement 👎
	// 			</button>
	// 		</div>
